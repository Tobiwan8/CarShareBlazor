...
{
    public class CheckIfUserHasPerson
    {
        public async Task<PersonModel?> CheckIfUserHasPersonAsync(int userID)
        {
            ...
            var requestUrl = "api/Person/userid" + queryString.ToString();
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                return JsonConvert.DeserializeObject<PersonModel>(responseContent);
            }
            return null;
        }
    }
